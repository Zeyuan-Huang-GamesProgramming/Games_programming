...
A first-person sci-fi survival escape game made in Unity. The player explores an abandoned space station, repairs critical systems, manages oxygen and time pressure, opens the evacuation route, and escapes through the pod.
...
For more detailed steps, see `UNITY_RUN.md`.
